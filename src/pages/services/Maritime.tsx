  ...
  return (
    <div className="space-y-12">
      <section className="relative isolate w-full overflow-hidden rounded-xl">
        <img src={maritimeImg} alt="Maritime bunker forecasting" className="absolute inset-0 h-full w-full object-cover object-center" loading="eager" fetchPriority="high" />
